...
{#if !files}
	<div class="flex items-center justify-center w-full">
		...
		>
			...
			<input type="file" bind:files id="file-upload" class="hidden" on:change={handleFileChange} />
		</label>
	</div>
				...
				>
					...
					>
						<p class="z-10 text-xs font-light text-center text-gray-500">
							Drag & Drop your files here <br /><br /> or <br /><br /> Click here and choose file
						</p>
...
{:else}
	<!-- アップロードされたオーディオファイルのファイル名と再生時間を表示し、おしゃれなアップロードボタンを置く。 -->
	<!-- また、このオーディオファイルを編集しますか？という文言をわかりやすく記載する。-->
	...
	> -->
	<GradientButton outline color="tealToLime" />
	<button
